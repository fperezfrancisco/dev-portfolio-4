      ...
      <div className="w-full space-y-4">
        ...
        >
          <p className="w-full max-w-[500px] md:max-w-[650px] mx-auto tracking-tight">
            Hi - I’m Francisco, a full stack engineer out of Los Angeles, CA
            with a passion for building meaningful applications from start to
            finish. With a keen eye for innovation and creativity, I am always
            in search for how I can use my skills to revolutionize the world
            around me.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          <p className="w-full max-w-[500px] md:max-w-[650px] mx-auto tracking-tight">
            ...
            to design and launch production-ready platforms, including a youth
            sports club website serving 200+ families and a training academy
            platform that increased client registrations by 5x. At Vistora
            Technologies, I
            <span className="text-[color:var(--accent)]">
              {" "}
